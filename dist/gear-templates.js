angular.module('gearUi').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('gear-templates/color-picker-group',
  ...
  $templateCache.put('gear-templates/date-picker-group',
  ...
  $templateCache.put('gear-templates/date-picker',
  ...
  $templateCache.put('gear-templates/main-menu-item',
  ...
  $templateCache.put('gear-templates/main-menu-list',
  ...
  $templateCache.put('gear-templates/main-menu',
  ...
  $templateCache.put('gear-templates/snack-bar',
  ...
  $templateCache.put('gear-templates/snack-container',
    "<gear-snack-bar ng-repeat=\"bar in bars\" gear-bar=bar ng-if=\"$index == 0\"></gear-snack-bar>"
  );


  $templateCache.put('gear-templates/time-picker-group',
  ...
  $templateCache.put('gear-templates/time-picker',
    "<div class=\"header\">\r" +
    "\n" +
  ...
  $templateCache.put('gear-templates/user-area',
