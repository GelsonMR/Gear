...
.directive('gearColorPickerGroup', function($timeout){
	return {
		...
		templateUrl: 'gear-templates/color-picker-group.html',
...
.directive('gearDatePicker', function($timeout){
	return {
		...
		templateUrl: 'gear-templates/date-picker.html',
		link: function(scope, element, attrs, ctrl) {
...
.directive('gearDatePickerGroup', function($filter, $timeout){
	return {
		...
		templateUrl: 'gear-templates/date-picker-group.html',
		replace: true,
...
.directive('gearUserArea', function($timeout){
	return {
		...
		templateUrl: 'gear-templates/user-area.html',
		link: function(scope, element, attrs){
			element.bind('click', function(){
...
.directive('gearSnackContainer', function(gearSnack, gearColor, $timeout){
	return {
		restrict: 'E',
		templateUrl: 'gear-templates/snack-container.html',
		link: function(scope, element, attrs) {
			var timeout;
			scope.activeBar;
			scope.bars = [];
...
.directive('gearSnackBar', function(gearSnack){
	return {
		restrict: 'E',
		templateUrl: 'gear-templates/snack-bar.html',
		scope: {
			'gearBar': '='
		},
		link: function(scope, element, attrs) {
...
.directive('gearTimePicker', function($timeout){
	return {
		...
		templateUrl: 'gear-templates/time-picker.html',
		link: function(scope, element, attrs, ctrl) {
			scope.hourType = 24;
...
.directive('gearTimePickerGroup', function($filter, $timeout){
	return {
		...
		templateUrl: 'gear-templates/time-picker-group.html',
		replace: true,
		link: function(scope, element, attrs, ctrls) {
			'autocomplete' in attrs && element.find('input:first').attr('autocomplete', attrs.autocomplete);
			scope.required = 'required' in attrs;
...
.directive('gearMainMenu', function(){
	return {
		...
		templateUrl: 'gear-templates/main-menu.html',
...
.directive('gearMainMenuList', function(){
	return {
		...
		templateUrl: 'gear-templates/main-menu-list.html',
		link: function(scope, element, attrs) {
			scope.filteredList = [];
...
.directive('gearMainMenuItem', function($compile){
	return {
		...
		templateUrl: 'gear-templates/main-menu-item.html',
		link: function(scope, element, attrs, ctrl) {
